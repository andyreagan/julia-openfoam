...
forecastflux = zeros(length(start_assimilation:window:end_assimilation))
analysisflux = zeros(length(start_assimilation:window:end_assimilation))
groundFlux = zeros(Nens,length(start_assimilation:window:end_assimilation))

# for t=1:length(start_assimilation:window:end_assimilation)
# 
#     f,a = assimilate(observations,t,R,points,Nens,ens)
#     analysis[t] = a
#     forecast[t] = f
