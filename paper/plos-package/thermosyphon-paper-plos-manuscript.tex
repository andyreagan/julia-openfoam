...
\pagestyle{fancy}
\fancyhf{}
\lhead{\includegraphics[width=2.0in]{PLOS-letterhead.pdf}}
...
\\
\bigskip
\textbf{1} Department of Mathematics \& Statistics, Vermont Complex Systems Center, Computational Story Lab, \& the Vermont Advanced Computing Core, The University of Vermont, Burlington, VT 05405, USA
\\
\textbf{2} School of Engineering, Vermont Complex Systems Center \& the Vermont Advanced Computing Core, The University of Vermont, Burlington, VT 05405, USA
\\
...
The function $h(x)$ is a defined piece-wise analytic polynomial, and is provided in the full derivation in S2 Appendix.
...
\begin{figure}[h]
  \centering
  %% \includegraphics[width=0.45\textwidth]{fig1_harris-tellus-2012-loop.tiff}
...
\begin{figure}[h]
  \centering
  %% \includegraphics[width=0.5\textwidth]{fig2_2015-09-30-12-26-221-timeseries.tiff}
