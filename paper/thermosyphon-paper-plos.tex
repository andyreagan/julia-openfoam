...
\pagestyle{fancy}
\fancyhf{}
\lhead{\includegraphics[width=2.0in]{plos/PLOS-submission.eps}}
...
\begin{flushleft}
{\Large
\textbf\newline{\input{\filenamebase.title} - Submission to PLOS Journals}
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
\input{\filenamebase.author.plos}
\bigskip
